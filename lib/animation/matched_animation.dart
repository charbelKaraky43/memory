  ...
  void didUpdateWidget(covariant MatchedAnimation oldWidget) {
    if (widget.animate) {
      if (!_correctColorIsSet) {
        ...
        } else if (widget.numberOfWordsAnswered == 6) {
          _correctColor = Colors.amber;
        } else if (widget.numberOfWordsAnswered == 8) {
          _correctColor = Colors.pinkAccent;
        } else if (widget.numberOfWordsAnswered == 10) {
          _correctColor = Colors.orange;
        } else if (widget.numberOfWordsAnswered == 12) {
          _correctColor = Colors.deepOrange;
        } else if (widget.numberOfWordsAnswered == 14) {
          _correctColor = Colors.purple;
        } else if (widget.numberOfWordsAnswered == 16) {
          _correctColor = Colors.teal;
        } else if (widget.numberOfWordsAnswered == 18) {
          _correctColor = Colors.indigo;
        }
      }
